...
rem Run Goose up command
echo Running goose up...
%GOOSE_CMD% -dir %MIGRATION_DIR% postgres "user=postgres password=postgres dbname=postgres host=localhost port=5432 sslmode=disable" up
